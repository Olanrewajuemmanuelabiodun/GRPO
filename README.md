...
To train the model further say max_steps = 500 which is where the aha moment occur it is advised to use LLM parallelism tecnhiques to esnure distributed training. Training for max_steps = 500 on a single GPU will take days. 
